"""Tag audit service: manage tag_audit records."""
...
from app.models.tag_audit import TagAuditModel


class TagAuditService:
    """Manage the lifecycle of tag_audit rows."""
...
def create_tag_audit_service() -> TagAuditService:
    """Create a TagAuditService instance."""
